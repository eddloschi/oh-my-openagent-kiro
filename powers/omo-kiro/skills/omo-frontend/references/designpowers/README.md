...
- `/omo-visual-qa` still owns objective rendered evidence for visual claims.
- `/omo-plan`, `/omo-start-work`, and `/omo-review-work` still own planning, execution, and final implementation review when those phases apply.
...
- significant implementation work routes through `/omo-review-work`.
